...
public class Vector2f {
    ...
    public Vector2f(Vector2 vect) {this.x=vect.getX();this.y=vect.getY(); }
    ...
    public static Vector2f sub(Vector2 vec1, Vector2f vec2) {
        Vector2f newVec= new Vector2f(vec1);
        newVec.sub(vec2);
        return newVec;
    }
    ...
    public static Vector2f mul(Vector2 vec1, float val1, float val2) {
        Vector2f newVec= new Vector2f(vec1);
        newVec.mul(val1,val2);
        return newVec;
    }
    ...
    public static Vector2f div(Vector2f vec1, Vector2 vec2) {
        Vector2f newVec= new Vector2f(vec1);
        newVec.div(vec2);
        return newVec;
    }
    ...
    public boolean checkIfEqual(Vector2 vec2) { return ((int)this.x)==vec2.getX()&&((int)this.y)==vec2.getY();}
